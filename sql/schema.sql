CREATE DATABASE IF NOT EXISTS harmony_bot
...
CREATE TABLE IF NOT EXISTS wallet_ledger (
    ...
    type ENUM(
      ...
      'internal_in',     -- دریافت داخلی از کاربر دیگر
      'internal_out',    -- ارسال داخلی به کاربر دیگر
      'admin_adjust'     -- تغییر دستی توسط ادمین
    ) NOT NULL,
